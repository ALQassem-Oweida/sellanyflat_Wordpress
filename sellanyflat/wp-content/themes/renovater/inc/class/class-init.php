...
class Init {
	...
	public function theme_config() {
		return array(
			...
			'description'  => esc_html__( 'By just installing and activate Gutenverse plugin you will be able to use this theme\'s advanced templates. With Gutenverse plugin installed, you gain access to both advance version of templates and block patterns for free which all built using Gutenverse blocks.', 'renovater' ),
			...
			'note2'        => esc_html__( 'Note 2: (Gutenverse version 1.2.4 & above required!)', 'renovater' ),
