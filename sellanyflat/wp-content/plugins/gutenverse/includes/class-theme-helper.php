...
class Theme_Helper {
	...
	public function __construct() {
		...
		// Filter.
		add_filter( 'get_block_templates', array( $this, 'get_block_template' ), null, 3 );
	...
	public function register_block_core_template_part() {
		register_block_type_from_metadata(
			...
			array(
				...
				'variations'      => $this->build_template_part_block_variations(),
			)
		);
	}
	 ...
	 */
	public function build_template_part_block_variations() {
		$variations    = array();
