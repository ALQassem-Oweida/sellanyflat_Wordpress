...
class Nav_Menu extends Block_Abstract {
	...
	public function render_content( $remove_link = false ) {
		...
		return '<div id="' . $element_id . '" class="guten-element guten-nav-menu nav-menu break-point-' . $menu_breakpoint . ' ' . $submenu_click . $display_classes . $animation_class . '" data-item-indicator="' . $item_indicator . '" data-close-on-click="' . $closeon_click . '">
